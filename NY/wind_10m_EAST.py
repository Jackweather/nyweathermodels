...
grib_dir = os.path.join(BASE_DIR, "wind_10m_EAST", "grib")
png_dir = os.path.join(BASE_DIR, "wind_10m_EAST", "png")
...
def plot_wind_10m(u_path, v_path, step):
    ...
    # Do not mask wind data to region; plot full grid
    ...
    title = (
        f"HRRR 10m Wind — Northeast/Mid-Atlantic US\n"
    ...
    # Save PNG
    png_path = os.path.join(png_dir, f"hrrr_wind_10m_EAST_{step:02d}.png")
