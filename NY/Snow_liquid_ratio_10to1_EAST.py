...
grib_dir = os.path.join(BASE_DIR, "SNOW_10to_1_EAST", "grib")
png_dir = os.path.join(BASE_DIR, "SNOW_10to_1_EAST", "png")
os.makedirs(grib_dir, exist_ok=True)
os.makedirs(png_dir, exist_ok=True)

# File to track completed forecast steps for the current run
processed_steps_file = os.path.join(BASE_DIR, "SNOW_10to_1_EAST", "processed_steps.txt")
...
def plot_weasd_surface(weasd_path, step):
    ...
    title = (
        f"HRRR Surface Snow Depth (Snow Liquid Ratio 10:1) — Northeast US\n"
    ...
    # Save PNG
    png_path = os.path.join(png_dir, f"hrrr_10_to_1_SNOW_EAST_{step:02d}.png")
